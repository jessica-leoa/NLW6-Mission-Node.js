...
//Criar uma interface definindo características de um objeto, parecido com uma funca, mas é apenas uma interface que server como contrato de implementacao.


interface usuario{
  // telefone?: parametro opcional a ser definido
